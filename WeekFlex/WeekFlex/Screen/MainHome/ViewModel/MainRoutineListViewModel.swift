...
struct MainRoutineListViewModel {
    ...
    init() {
        ...
        let routine1 = MainRoutineItemViewModel(routineName: "영어마스터", tasks:[
            TaskItemViewModel(taskTitle: "영어원서 읽기", category: "icon-24-star-n", time: "9:00am - 10:00am", done: false ),
            TaskItemViewModel(taskTitle: "영드보기", category: "icon-24-star-n", time: "10:20am - 11:00am", done: false ),
            TaskItemViewModel(taskTitle: "단어외우기", category: "icon-24-star-n" , time: "10:00am - 11:00am", done: false)
        ])
        
        let routine2 = MainRoutineItemViewModel(routineName: "시험공부", tasks:[
            TaskItemViewModel(taskTitle: "전공1", category: "icon-24-star-n", time: "2:00pm - 3:00pm", done: false ),
            TaskItemViewModel(taskTitle: "교양", category: "icon-24-star-n", time: nil, done: false )
        ])
